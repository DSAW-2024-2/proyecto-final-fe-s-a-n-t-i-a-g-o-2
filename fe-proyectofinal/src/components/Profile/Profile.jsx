      ...
      <div className="container mx-auto p-6 flex-grow text-white">
        ...
        <div className="bg-black bg-opacity-75 p-8 rounded-lg shadow-lg max-w-lg mx-auto">
          <div className="mb-4">
            ...
            {user.photo && (
              <div className="mt-4 flex justify-center">
                <div>
                  <strong className="block text-center text-green-500">Foto de Perfil:</strong>
                  <img
                    src={user.photo}
                    alt="Foto de Perfil"
                    className="w-32 h-32 rounded-full mt-2 border-4 border-green-500"
                  />
                </div>
              </div>
            )}
          ...
          <div className="mt-6 flex flex-col items-center space-y-4">
            <button
              className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 w-full max-w-xs"
              onClick={() => navigate('/edit-profile')}
            >
              Editar Perfil
            </button>
            <button
              className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 w-full max-w-xs"
